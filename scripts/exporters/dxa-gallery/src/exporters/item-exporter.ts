 ...
 * membership union, and a gallery's members can be native records, borrowed
 * from several other databases, or both at once. So the source project printed
 * on the sheet and the context that selects a record's canonical translation
 * are genuinely per-item here, never a per-export constant.
 */
