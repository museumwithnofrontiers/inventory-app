...
export class Database {
   ...
   *
   * A gallery's members are a mix of native and BORROWED records (carpets: 398
   * of its own DCA objects plus 59 EPM, 21 ISL, 4 Sharing History, 2 BAR, 1
   * EXTHE and 1 GALLERIES), so neither the project key shown on the item sheet
   * nor the context that selects its canonical translation can be a per-export
   * constant the way it is for the single-project exporters.
   */
