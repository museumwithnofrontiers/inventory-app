...
export interface Gallery {
  ...
  /** Legacy slug from `thg_gallery.link` (e.g. `carpets`, `amulets_and_talismans`). */
  slug: string | null
  /** Canonical public host from `thg_gallery_url` (e.g. `https://carpets.museumwnf.org`). */
  host: string | null
  /** Legacy mwnf3 project the gallery was created under (e.g. `DCA`). */
  mwnf3ProjectId: string | null
  /**
   * Inventory UUID of that same project, or null when the gallery has no
   * mwnf3 project (galleries 43/45) or the project was never imported.
