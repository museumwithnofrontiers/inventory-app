...
export class ExhibitionExporter extends BaseExporter {
   ...
   * them rather than dropping them. Empty on Colours (the affected exhibitions
   * are 54 and Water in Islam), and the field ships anyway so a viewer written
   * against this package handles the case without a shape change.
   */
