...
export interface ExhibitionI18n {
  /** 'Y' / 'N' — whether this language is public; can disagree between languages. */
  enabled?: string
  subtitle?: string
  heading?: string
  about?: string
...
export interface Exhibition {
  ...
  /** Legacy slug from `thg_gallery.link`, underscore form (legacy identity, kept verbatim). */
  slug: string | null
  /** Canonical public host from `thg_gallery_url`. */
  host: string | null
  /** Legacy mwnf3 project the exhibition was created under. */
